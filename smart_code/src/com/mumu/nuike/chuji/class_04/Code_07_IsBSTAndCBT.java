package com.mumu.nuike.chuji.class_04;
...
public class Code_07_IsBSTAndCBT {
	...
	public static boolean isBST(TreeNode head) {	// 判断搜索二叉树--->可以用中序遍历判断方法，不在本代码，
	...
	public static boolean isCBT(TreeNode head) {	// 判断是否是完全二叉树：没左有右；有左没右；有左有右；共三种可能。============
	...
	public static void printInOrder(TreeNode head, int height, String to, int len) {	// 表示二叉树的方法
		if (head == null) {
			return;
		}
