...
public class CodeBlock {
     ...
     * 一般情况下，如果有些代码需要在项目启动的时候就执行，这时候就需要静态代码块。比如一个项目启动需要加载的很多配置文件等资源，
     * 我们就可以都放入静态代码块中。
     *
     ...
     * 而一般的方法不存在这一特点
     *
     * 4. 普通代码块：普通代码块和构造代码块的区别是，构造代码块是在类中定义的，而普通代码块是在方法体中定义的。
     * 且普通代码块的执行顺序和书写顺序一致。
     *
    ...
    public CodeBlock(String str) {
        System.out.println("有参构造函数执行~" + str);
    }

    public static CodeBlock cb1 = new CodeBlock();
