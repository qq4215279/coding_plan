...
package com.gobestsoft.java_base.reflect.reflect;

import com.gobestsoft.java_base.reflect.domain.Person;
...
public class ReflectDemo2 {
     ...
     *  Constructor<T> getDeclaredConstructor(类<?>... parameterTypes) Constructor<?>[] getDeclaredConstructors()
     *
     * 3. 获取成员方法们：
